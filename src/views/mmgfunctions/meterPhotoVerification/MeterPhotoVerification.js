    ...
    <CRow>
      ...
      >
        ...
        <CModalBody>
          ...
          <CModalFooter>
            <CButton color="primary" onClick={() => console.log("Submit")}>Submit</CButton>
            <CButton color="secondary" onClick={() => setVisibleXL(false)}>Cancel</CButton>
          </CModalFooter>
        </CModalBody>
      </CModal>
              ...
              <CCol sm={3}
                ...
                <CButtonGroup role="group" aria-label="Basic radio button group">
                  ...
                  <CFormCheck
                    ...
                    autoComplete="off"
                    value="NON-TAB"
                    checked={selectedValues.caseType === "NON-TAB"} // Fixing the mismatch here
                    onChange={handleRadioChange} // Handle radio change
                    label="Non-Tab"
                  />
                </CButtonGroup> */}
