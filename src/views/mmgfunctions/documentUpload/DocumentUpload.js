...
const handleFileUpload = () => {
  ...
  if (selectedFile) {
    ...
    // Add file upload functionality as needed
  }
};
      ...
      <CCol xs={12}>
        <CCard className="mb-4">
          <CCardHeader className="text-center" style={{ fontSize: '1.3rem' }}>
            ...
            <strong>DOCUMENT UPLOAD FORM</strong>
            ...
            <CRow>
              ...
              <CCol sm={4} className="mb-1">
                <CFormSelect
                  ...
                  floatingLabel={
                    <>
                      <span style={textSmallStyle}>Company</span>{' '}
              ...
              <CCol sm={4} className="mb-1">
                <CFormSelect
                  ...
                  floatingLabel={
                    <>
                      <span style={textSmallStyle}>Circle</span>{' '}
                      <span className="text-danger">*</span>
                    </>
                  }
                  aria-label="Circle"
            ...
            <CCol sm={4} className="mb-1">
              ...
              <CCol sm={4} className="mb-1">
                <CFormSelect
                  ...
                  floatingLabel={
                    <>
                      <span style={textSmallStyle}>Document Name</span>{' '}
                      <span className="text-danger">*</span>
                    </>
                  }
                  aria-label="Company"
              ...
              <CCol sm={4}>
                <CFormInput
                  ...
                  floatingLabel={
                    <>
                      <span style={textSmallStyle}>Detail Remark</span>
                    </>
                  }
                  placeholder="Enter Detail Remarks"
...
<CCol sm={4}>
        ...
        {selectedFile && (
          <div className="mt-2">
            ...
            <CButton color="success" onClick={handleFileUpload}>
              Upload Document
            </CButton>
          </div>
        )}
